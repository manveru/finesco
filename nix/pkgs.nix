{
  pkgs = hackage:
    {
      packages = {
        ...
        "pandoc".revision = (((hackage."pandoc")."2.6").revisions).default;
        ...
        "skylighting".flags.system-pcre = false;
        ...
        "pandoc-citeproc".revision = (((hackage."pandoc-citeproc")."0.16.1.3").revisions).default;
        ...
        "hakyll".revision = (((hackage."hakyll")."4.12.5.1").revisions).default;
        ...
        "HTTP".revision = (((hackage."HTTP")."4000.3.13").revisions).default;
  ...
  extras = hackage:
    { packages = { finesco = ../.plan.nix/finesco.nix; }; };
  }
