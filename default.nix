...
let
  ...
  # TODO:
  # Ruby is pretty slow for this but gives us great flexibility in parsing.
  # Probably should rewrite it in something faster once I decide on a final
  # format.
  parseMarkdown = src:
    let
      raw = mkDerivation {
...
commonMarkdownAttrs = id: lib.recursiveUpdate {
  ...
  links = [
    {url = "/"; text = "Home";}
    {url = "/about.html"; text = "会社概要";}
    {url = "/service.html"; text = "サービス一覧";}
    {url = "/soudan.html"; text = "ご相談の流れ";}
    {url = "/info.html"; text = "お知らせ";}
    {url = "/column.html"; text = "コラム";}
    {url = "/blog.html"; text = "ブログ";}
    {url = "/contact.html"; text = "お問い合わせ";}
    {url = "/english.html"; text = "ENGLISH";}
    {url = "https://ja-jp.facebook.com/Finesco-Inc-427977463911779/"; text = "Facebook";}
  ];
